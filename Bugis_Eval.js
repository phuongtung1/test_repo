/**
 * to use this code: import Bugis_Eval from this js file as well as the GI module
 * run Bugis_Eval with the GI module as input along with other start node input
 * e.g.:
 * const Bugis_Eval = require('./Bugis_Eval.js').Bugis_Eval
 * const module = require('gi-module')
 * const result = Bugis_Eval(module, start_input_1, start_input_2, ...);
 *
...
function Bugis_Eval(__modules__) {
...
function exec_Bugis_Eval(__params__){

function exec_Bugis_Eval_node_0t44g22c6jz(__params__){
while (true) {
...
function exec_Bugis_Eval_node_60dacnxla8h(__params__){
while (true) {
__modules__._model.__preprocess__( __params__.model);

let coll_ = __modules__.collection.Get( __params__.model, "context" );
...
function exec_Bugis_Eval_node_prjbq4r9gf(__params__){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
function exec_Bugis_Eval_node_ghw3w22tjm(__params__){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
function exec_Bugis_Eval_node_rikexw4pu0r(__params__){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
function exec_Bugis_Eval_node_2azdttrz5jm_sigmoid_(__params__, values_, minmax_) {
...
function exec_Bugis_Eval_node_2azdttrz5jm(__params__){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let sun_exposure_score_values_ = exec_Bugis_Eval_node_2azdttrz5jm_sigmoid_(__params__, sun_exposure_list_, [0, 0.7]);
...
function exec_Bugis_Eval_node_eb6seorxgpf_sigmoid_(__params__, values_, minmax_) {
...
function exec_Bugis_Eval_node_eb6seorxgpf(__params__){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let noise_score_values_ = exec_Bugis_Eval_node_eb6seorxgpf_sigmoid_(__params__, noise_list_, [0, 0.02]);
if (__params__.terminated) { return __params__.model;}
...
function exec_Bugis_Eval_node_2ju8xciwxgs_sigmoid_(__params__, values_, minmax_) {
...
function exec_Bugis_Eval_node_2ju8xciwxgs(__params__){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let sky_exposure_score_values_ = exec_Bugis_Eval_node_2ju8xciwxgs_sigmoid_(__params__, sky_exposure_list_, [0.3, 0.1]);
if (__params__.terminated) { return __params__.model;}
...
function exec_Bugis_Eval_node_xrdfngm5dzj_sigmoid_(__params__, values_, minmax_) {
...
function exec_Bugis_Eval_node_xrdfngm5dzj(__params__){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let unob_view_score_values_ = exec_Bugis_Eval_node_xrdfngm5dzj_sigmoid_(__params__, unob_view_list_, [1, 0.3]);
if (__params__.terminated) { return __params__.model;}
...
function exec_Bugis_Eval_node_66kri5q6cyv_radarChart_(__params__, values_, origin_, radius_) {
...
function exec_Bugis_Eval_node_66kri5q6cyv(__params__){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
let coll_radar_ = exec_Bugis_Eval_node_66kri5q6cyv_radarChart_(__params__, scores_, [0, 0, 0], 30);
if (__params__.terminated) { return __params__.model;}
...
function exec_Bugis_Eval_node_6d9f3zuh43v(__params__){
while (true) {
__modules__._model.__preprocess__( __params__.model);
...
printFunc(__params__.console,'result', result_);
...
var merged;
let result_exec_Bugis_Eval_node_agvb2trcxbg = __params__.model;

__params__.model = duplicateModel(result_exec_Bugis_Eval_node_agvb2trcxbg);
let result_exec_Bugis_Eval_node_0t44g22c6jz = exec_Bugis_Eval_node_0t44g22c6jz(__params__);

__params__.model = duplicateModel(result_exec_Bugis_Eval_node_agvb2trcxbg);
let result_exec_Bugis_Eval_node_60dacnxla8h = exec_Bugis_Eval_node_60dacnxla8h(__params__);

__params__.model = duplicateModel(result_exec_Bugis_Eval_node_agvb2trcxbg);
let result_exec_Bugis_Eval_node_prjbq4r9gf = exec_Bugis_Eval_node_prjbq4r9gf(__params__);

__params__.model = mergeInputs([result_exec_Bugis_Eval_node_60dacnxla8h, result_exec_Bugis_Eval_node_prjbq4r9gf]);
let result_exec_Bugis_Eval_node_ghw3w22tjm = exec_Bugis_Eval_node_ghw3w22tjm(__params__);

__params__.model = result_exec_Bugis_Eval_node_agvb2trcxbg;
let result_exec_Bugis_Eval_node_rikexw4pu0r = exec_Bugis_Eval_node_rikexw4pu0r(__params__);

__params__.model = mergeInputs([result_exec_Bugis_Eval_node_ghw3w22tjm, result_exec_Bugis_Eval_node_rikexw4pu0r]);
let result_exec_Bugis_Eval_node_2azdttrz5jm = exec_Bugis_Eval_node_2azdttrz5jm(__params__);

__params__.model = mergeInputs([result_exec_Bugis_Eval_node_0t44g22c6jz, result_exec_Bugis_Eval_node_ghw3w22tjm, result_exec_Bugis_Eval_node_rikexw4pu0r]);
let result_exec_Bugis_Eval_node_eb6seorxgpf = exec_Bugis_Eval_node_eb6seorxgpf(__params__);

__params__.model = mergeInputs([result_exec_Bugis_Eval_node_ghw3w22tjm, result_exec_Bugis_Eval_node_rikexw4pu0r]);
let result_exec_Bugis_Eval_node_2ju8xciwxgs = exec_Bugis_Eval_node_2ju8xciwxgs(__params__);

__params__.model = mergeInputs([result_exec_Bugis_Eval_node_ghw3w22tjm, result_exec_Bugis_Eval_node_rikexw4pu0r]);
let result_exec_Bugis_Eval_node_xrdfngm5dzj = exec_Bugis_Eval_node_xrdfngm5dzj(__params__);

__params__.model = mergeInputs([result_exec_Bugis_Eval_node_2azdttrz5jm, result_exec_Bugis_Eval_node_eb6seorxgpf, result_exec_Bugis_Eval_node_2ju8xciwxgs, result_exec_Bugis_Eval_node_xrdfngm5dzj]);
let result_exec_Bugis_Eval_node_66kri5q6cyv = exec_Bugis_Eval_node_66kri5q6cyv(__params__);

__params__.model = result_exec_Bugis_Eval_node_66kri5q6cyv;
let result_exec_Bugis_Eval_node_6d9f3zuh43v = exec_Bugis_Eval_node_6d9f3zuh43v(__params__);

return result_exec_Bugis_Eval_node_6d9f3zuh43v;
}
...
const result = exec_Bugis_Eval(__params__);
