...
let x_ = __modules__.make.Copy( __params__.model, __modules__.query.Get(__params__.model, 'co', null), null );

__modules__.modify.Delete( __params__.model, x_, 'keep_selected' );
